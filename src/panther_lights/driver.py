...
class Animation:
    ...
    class Type(Enum):
        ...
        DOUBLE_COLOR_WIPE_NORMAL = 11
        DOUBLE_COLOR_WIPE_FAST = 12
    ...
    def double_snake(self, speed):
        ...
        if self.frame_count == 0:
            ...
            update_frame = True
        elif self.double_snake_index[1] < self.num_pixel + 3:
...
def main():
    ...
    while 1:
        try:
            my_queue.put(PantherLights.Message('FADE_COLOR', 0xEEDD00, 'FADE_COLOR', 0xEEDD00,))
            time.sleep(4)
            my_queue.put(PantherLights.Message('COLOR_WIPE_HALF_DOWN_FAST', 0xff6600, 'COLOR_WIPE_HALF_UP_FAST', 0xff6600,))
            time.sleep(4)
            my_queue.put(PantherLights.Message('COLOR_WIPE_HALF_UP_FAST', 0xff6600, 'COLOR_WIPE_HALF_DOWN_FAST', 0xff6600,))
            time.sleep(4)
            my_queue.put(PantherLights.Message('DOUBLE_COLOR_WIPE_FAST', 0xff0000, 'SOLID_COLOR', 0xff0000))
            time.sleep(4)
